                ...
                <nuxt-link :to="'#'" class="tile tile-overlay-container is-child box">
                  ...
                  <div class="columns">
                    ...
                    <div class="column">
                      ...
                      <p class="subtitle">{{course.subtitle || "ยังไม่มีข้อความ subtittle ในตอนนี้ครับ"}} </p>
                      <span class="tag"
                            :class="createCourseClass(course.status)">{{course.status}}</span>
                    </div>
