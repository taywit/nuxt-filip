              ...
              <div class="field">
                <div class="control">
                  ...
                  class="form-error">
                    ...
                    class="help is-danger">Name not less than 6 characters</span>
                  </div>
                </div>
              </div>
              <div class="field">
                <div class="control">
                  ...
                  class="form-error">
                    ...
                    class="help is-danger">กรุณากรอก Email ด้วย!</span>
                    <span
                    v-if="!$v.form.email.emailValidator" 
                    class="help is-danger">Email address ไม่ถูกต้อง</span>
                  </div>
                </div>
              </div>
              <div class="field">
                <div class="control">
                  ...
                  class="form-error">
                    <span 
                      ...
                      class="help is-danger">ไม่สามารถใช้ url ที่คุณใส่ข้อมูลได้!
                    </span>
                    <span
                      v-if="!$v.form.avatar.supportedFileType" 
                      class="help is-danger">ประเภทของ file ที่คุณเลือกไม่ถูกต้อง!
                    </span>
                  </div>
                </div>
              </div>
